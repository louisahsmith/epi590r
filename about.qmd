...
**SEMESTER:** Fall 2024 (Preterm)

**COURSE TITLE:** R Bootcamp

**CLASS HOURS AND LOCATION:** August 19 & 20, 9am-12:30pm & 1:30pm-5pm
...
**Final project:** The final project will provide an opportunity to bring together the skills you have learned in class and will be due after the course (tentative due date September 4). The project will consist of a reproducible, real-world epidemiologic analysis. The goal of the analysis will be the process and workflow rather than the scientific process or conclusions. The final project will be submitted via GitHub.
...
|           |                         |                                                  |                                                                                                                                   |                   |        |
| 1         | 19-Aug                  | Reproducible research and workflows in R         | -   <https://www.tidyverse.org/blog/2017/12/workflow-vs-script/>                                                                  | In-class activity |        |
|           |                         |                                                  | -   Perkel, J. M. (2018). A toolkit for data transparency. *Nature*, *560* (7719), 513-515.                                       |                   |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
|           |                         |                                                  |                                                                                                                                   |                   |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
| 2         | 19-Aug                  | Introduction to Git and GitHub                   | -   <https://happygitwithr.com/>                                                                                                  | In-class activity |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
| 3         | 19-Aug                  | R projects and file management                   | -   <https://malco.io/articles/2018-11-05-why-should-i-use-the-here-package-when-i-m-already-using-projects> \| In-class activity |                   |        |
|           |                         |                                                  | -   <https://here.r-lib.org/> \| \|                                                                                               |                   |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
| 4         | 19-Aug                  | Package management with renv                     | -   <https://rstudio.github.io/renv/articles/renv.html>                                                                           | In-class activity |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
| 5         | 20-Aug                  | Descriptive and regression tables with gtsummary | -   <https://www.danieldsjoberg.com/gtsummary/>                                                                                   | In-class activity |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
| 6         | 20-Aug                  | Introduction to quarto                           | -   <https://quarto.org/docs/guide/>                                                                                              | In-class activity |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
| 7         | 20-Aug                  | Function wrapping                                | -   <https://adv-r.hadley.nz/functions.html>                                                                                      | In-class activity |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
| 8         | 20-Aug                  | Introduction to targets                          | -   <https://books.ropensci.org/targets/>                                                                                         | In-class activity |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
|           | September 4 (tentative) |                                                  |                                                                                                                                   | Final project due |        |
+-----------+-------------------------+--------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------+--------+
