...
You will "turn in" your project by **submitting the link on** **Canvas** to your github repo by **September 4**. If it is a private repository, please invite `louisahsmith` and the TAs as collaborators so that we can access it.
